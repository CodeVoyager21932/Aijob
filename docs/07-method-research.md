...
1. Career OS Phase 1A–4：统一交互、领域契约、三个 PoC 与一岗全闭环。
2. Phase 4 后并行完成 Phase 5/6 产品收口，以及 100 家/1000 岗 G2 供给与三来源累计刷新 ≥3 次、跨度 ≥3 天的 G3（ADR-0035：不再要求连续 7 天在线）。
3. 服务器就绪后做 2 人校准与 6 人正式验证；300–500 岗只是从通过 G2 的 1000 岗中冻结的代表性研究子集。
4. Private Alpha：仅在产品 Phase、G0–G3、服务器、安全、删除和恢复演练全部通过后扩大邀请。
