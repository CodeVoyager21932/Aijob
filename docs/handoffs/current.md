...
2. **P0 自审收尾**：执行方逐条抽检批次 02 首批 8 条（硕方 5、鲸驰 1、神谷 1、红海云 1）与千寻快照 7 条；来源级自审通过后硕方提额至 6 条、千寻人工浏览前 3 页并导入满足最低字段要求的岗位。
3. 鹏扶按 ADR-0022 不补位；批次 03–06 名单与暂停条件已由计划预授权，不再等待逐批决定。
4. 台账回写：鹏扶法人名与申请链降级、红海云岗位名、千寻/万境双记录合并标注在 P0 完成；301–1000 家仍需逐步补齐行业、主体、导入处置和企业规模证据后分批合并主台账。
...
[ ] 已确认批次 02 首批 8 条与千寻快照 7 条由执行方自检自审，鹏扶按预设暂停且不补位
