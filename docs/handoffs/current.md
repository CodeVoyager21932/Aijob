...
coco 已在 P7 终局判定中选择继续扩容，并通过 ADR-0025 把企业目标从 20–30 家调整为 30–40 家；300–500 条可见岗位、SME 企业 60% 和 SME 岗位 50% 保持不变。批次 03/04 恢复已收束：先临三维 8、分享投资 1、北京鼎帷 1 通过，全志、昆仑芯、DTL 按结构或主体硬冲突暂停；目录现为 188 总供给、124 可见、19 家企业，SME 为 3/19 家与 10/124 岗位。**当前唯一目标是按固定 SME 队列执行批次 07+，企业达到 40 家立即停止。** 产品证据保持 `E0`，G0/G1 暂停。
...
```text
十九个可见企业，总供给 188 条、按 ADR-0021 配额可见 124 条
...
- 当前目录：总供给 188 条、可见 124 条、19 家企业；批次恢复新增先临三维 8、分享投资 1、北京鼎帷 1；被压缩 64 条保留全部不可变版本并在目录页公开"X/供给 Y"。
...
- 中小企业占比现状（公开分母）：有合格中小规模证据企业 3/19（红海云、先临三维、分享投资）、中小证据岗位 10/124；其余 `unknown` 按非中小计；距 60%/50% 目标缺口显著，不降低证据标准凑比例。
...
1. 按固定 SME 队列执行批次 07+；每批最多 5 家、每家首批最多 5 条，先完成官方人数规模证据、活动实习、完整字段和申请链硬门槛。
2. 目录硬指标仍未达：124 / 300 可见、19 / 30 家企业、SME 企业 15.79% / 60%、SME 岗位 8.06% / 50%。
...
[ ] 已确认目录为总供给 188 / 可见 124 条 local_mvp 岗位、19 家企业；通过来源 pending_review，三个硬冲突来源 paused
