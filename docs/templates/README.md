...
使用 [job-samples.csv](job-samples.csv) 记录或复核从已通过 G2 的 1000 岗目录中冻结的 300–500 条 G1 代表性研究子集。供给总 Gate 以 100 家/1000 岗和结构指标为准；每条样本至少保留企业规模证据、来源、原始链接、官方 URL 或企业域名邮箱、最后核验时间和当前活动状态。
