...
当前新路线的工程证据依次见 [M1 真实 Case 工作台](m1-real-case-workspace-acceptance-2026-08-09.md)、[M2 专业简历闭环](m2-professional-resume-acceptance-2026-08-11.md)、[M3-1 显式投递记录](m3-1-explicit-application-acceptance-2026-08-11.md)和 [M3-2 确定性文字面试](m3-2-deterministic-interview-acceptance-2026-08-11.md)。这些证据取代本目录历史 Phase 2B 验收中的“下一步”，但不删除历史工程事实；当前唯一目标只由动态路线与当前交接确定。
