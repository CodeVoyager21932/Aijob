...
| 当前范围 | 十个已接入来源 146 条本地岗位：原 31 条正确性基线、百度/京东/字节各 10 条已抽检增量、审批包 01 的帆软 18/慧策 30/灵明光子 7/普渡 30 已抽检增量；产品证据仍为 E0 |
...
| 来源发现进度 | 已按 ADR-0019 完成 1000/1000 家企业/机构审查记录；113 家有明确活动实习证据、227 家需复核、362 家仅为发现线索、296 家岗位已截止、2 家不是岗位。审批包 01（帆软、慧策、灵明光子、普渡）已获 coco 批准并完成低频核验与首批导入；千寻智能因飞书动态令牌按预设暂停转人工快照候选 |
| 工程切片 | 本地目录为普渡机器人 30、慧策 30、帆软 18、腾讯 14、字节 10、百度 10、美团 10、京东 10、南开就业网·好未来 7、灵明光子 7；新范围全量工程门以路线面板最新记录为准 |
...
这条链路只证明本地工程可行，不代表来源获准公开或产品价值已验证。十个已接入来源均为 `pending_review`，81 条岗位只进入本机 `local_mvp`；公开 `/v1/jobs` 仍返回空列表。腾讯上游的聚合占位 ID（`-2`、`-3`）会被拒绝并留下复核记录，不会伪装成真实岗位。
