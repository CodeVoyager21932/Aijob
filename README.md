...
> 2026-08-12：M1–M4 已完成；M4 通过[完整工程与浏览器总验收](docs/evidence/product/career-os-v2/m4-engineering-browser-gate-acceptance-2026-08-12.md)。决定进入 Private Alpha 准备，但真实供给、服务器、身份、安全和参与者工作尚未授权且仍须通过[就绪 Gate](docs/plans/private-alpha-readiness-gates.md)。旧 G4-first 严格总计划已[废止并归档](docs/plans/career-os-v2-upgrade-plan-2026-08-04.md)，不得再提供下一任务。
...
|---|---|
| 快照日期 | 2026-08-12 |
| 当前阶段 | Career OS 2.0 M1–M4 已完成；进入 Private Alpha 准备的决策等待 coco 单独授权。供给与服务器 Gate 通过前，G0/G1 继续暂停 |
...
| 工程切片 | M4 最终回归 Config 17、Contracts 79、Database 54、Platform 459、Web 141，共 750/750；lint 445、typecheck、build、audit 与 diff check 通过。主包仍为 564.42 kB；邮箱账号、真实 AI、真实来源和 contract migration 均未实施，公共版本仍为 0 |
